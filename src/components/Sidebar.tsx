...
export const navItems = [
  ...
  { name: "分析レポート", href: "/analytics", icon: BarChart3 },
];
  ...
  return (
    <aside className="fixed left-0 top-0 hidden h-full w-64 flex-col border-r border-slate-200/80 bg-slate-900/95 px-4 py-6 text-slate-100 shadow-2xl shadow-slate-900/20 lg:flex">
      <div className="mb-8 flex items-center gap-2 px-2">
        <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-emerald-500 text-white shadow-lg shadow-emerald-500/40">
          <span className="text-lg font-bold">F</span>
        </div>
        <div>
          <p className="text-sm text-slate-200/80">Flowlog</p>
      ...
      <div className="mt-auto space-y-2">
        <button className="flex w-full items-center gap-3 rounded-2xl px-4 py-3 text-sm font-semibold text-slate-200 transition hover:bg-white/5 hover:text-white">
          <span className="flex h-9 w-9 items-center justify-center rounded-xl border border-white/10">
            <Settings2 size={18} />
          </span>
          設定 / ログアウト
        </button>
        <button className="flex w-full items-center gap-3 rounded-2xl px-4 py-3 text-sm font-semibold text-slate-200 transition hover:bg-red-500/10 hover:text-white">
          <span className="flex h-9 w-9 items-center justify-center rounded-xl border border-white/10">
            <LogOut size={18} />
          </span>
          サインアウト（UIのみ）
